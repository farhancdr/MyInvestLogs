...
![Tests](https://img.shields.io/badge/tests-62%20unit%20%2B%2056%20e2e-success)
...
- **Where to send money** — bank details kept with the business, not retyped each time
...
npm run test:e2e   # 56 Playwright tests — the real app in a browser
npm run typecheck
```
